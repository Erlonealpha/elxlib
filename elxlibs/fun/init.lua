...
---@param state_x any?
---@param ... T...
---@overload fun(state_x: nil, ...: T...):nil
---@overload fun(state_x: std.NotNull<any>, ...: T...):T
...
---@param ... T...
---@return X
---@return R -- Emmylua BUG need remove `?` see: https://github.com/EmmyLuaLs/emmylua-analyzer-rust/issues/1244
---@overload fun(fun: (fun(...: T...):R), state_x: nil, ...: T...):nil
---@overload fun(fun: (fun(...: T...):R), state_x: X, ...: T...):X, R
...
function exports.str_concat(iterable, sep)
    ...
    if type(sep) ~= "string" then
        error(string.format('str_concat sep expected string, got %s', type(sep)))
    end
    local r = exports.reduce(function(a, b)
        if a == 0 then
            return b
        else
            return a..sep..b
